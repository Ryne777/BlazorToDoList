...
{
    public class EFGenericUnitOfWork<TContext> : IRepositoryFactory, IUnitOfWork<TContext>, IUnitOfWork where TContext : DbContext
    {
        ...
        public EFGenericUnitOfWork(TContext context)
        {
        ...
        public IRepository<TEntity> GetRepository<TEntity>(bool hasCustomRepository = false) where TEntity : class
        {
            ...
            {
                _repositories[type] = new EFGenericRepository<TEntity>(_context);
            }
